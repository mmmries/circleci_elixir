###
### This is based on https://github.com/CircleCI-Public/circleci-dockerfiles/blob/master/elixir/images/1.10.4/Dockerfile
### But we want to run on OTP 23 and Elixir 1.11.0, so we base it on one of the hexpm builds
###

FROM hexpm/elixir:1.11.0-erlang-23.1.1-debian-buster-20200607
